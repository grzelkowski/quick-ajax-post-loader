    ...
    var qapl_quick_ajax_post_loader_admin_scripts = {
        ...
        copy_code: function () {
            ...
            $(".copy-button-text").on("click", function () {
                ...
                self.copy_to_clipboard(code.text(), button, button.data("label-copied"), button.text());
            });
        },
        copy_input: function () {
            const self = this;
            $(".copy-button-input").on("click", function () {
                ...
                self.copy_to_clipboard(input.value, button, button.data("label-copied"), button.text());
            });
        },
