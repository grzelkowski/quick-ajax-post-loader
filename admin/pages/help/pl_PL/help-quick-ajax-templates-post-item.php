...
$accordion_block_content .= '<li><p>Dla domyślnego szablonu postów: plik musi być nazwany <code class="code-tag">post-item.php</code> i umieszczony w katalogu <code class="code-tag">/quick-ajax-post-loader/templates/post-items/</code>. Ten plik automatycznie zastąpi wbudowany domyślny szablon pluginu.</p></li>';
...
$accordion_block_content .= '<p>Możesz również dostosować komunikat wyświetlany, gdy nie ma żadnych postów do wyświetlenia, tworząc plik <code class="code-tag">no-posts.php</code> w katalogu <code class="code-tag">/quick-ajax-post-loader/templates/</code>, aby nadpisać domyślny komunikat.</p>';
