...
$accordion_block_title = 'add_filter: Jak używać `qapl_modify_term_buttons`';
$accordion_block_content = '<p><strong>Opis:</strong> Filtr <code class="code-tag">qapl_modify_term_buttons</code> umożliwia dostosowanie właściwości przycisków używanych do filtrowania zawartości strony na podstawie terminów taksonomii w pluginie <strong>Quick Ajax Post Loader</strong>. Dzięki przyjęciu dwóch parametrów: tablicy przycisków i identyfikatora AJAX, filtr oferuje możliwość dokładnej personalizacji tych elementów.</p>';
