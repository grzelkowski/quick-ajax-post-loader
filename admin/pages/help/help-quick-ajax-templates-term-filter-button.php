...
$accordion_block_content .= '<p>To customize the filter button, you need to override the <code class="code-tag">term-filter-button.php</code> file in the directory <code class="code-tag">/quick-ajax-post-loader/templates/term-filter/</code> in your theme or child theme. Modifying this file allows for changes in the style, class, and attributes of the button, enabling better alignment with the look and needs of your site.</p>';
