...
$accordion_block_title = 'add_filter: How to Use `qapl_modify_term_buttons`';
$accordion_block_content = '<p><strong>Description:</strong> The <code class="code-tag">qapl_modify_term_buttons</code> filter allows customization of the properties of buttons used for filtering site content based on taxonomy terms in the <strong>Quick Ajax Post Loader</strong> plugin. With two parameters: an array of buttons and an AJAX identifier, the filter offers the possibility of precisely personalizing these elements.</p>';
...
$accordion_block_content .= htmlentities("add_filter('qapl_modify_term_buttons', function(\$buttons, \$quick_ajax_id) {") . "\n";
