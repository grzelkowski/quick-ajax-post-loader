...
$accordion_block_content = '<p><strong>Description:</strong> The <strong>Quick Ajax Post Loader</strong> plugin allows for customization of the taxonomy filter button by modifying the <code class="code-tag">taxonomy-filter-button.php</code> file. This file is responsible for the appearance and functionality of the buttons used for filtering posts by category, tags, or other taxonomies.</p>';
$accordion_block_content .= '<h4>How to Customize the Filter Button</h4>';
$accordion_block_content .= '<p>To customize the filter button, you need to override the <code class="code-tag">taxonomy-filter-button.php</code> file in the directory <code class="code-tag">wp-content/themes/your-active-theme/quick-ajax-post-loader/templates/taxonomy-filter/</code> in your theme or child theme. Modifying this file allows for changes in the style, class, and attributes of the button, enabling better alignment with the look and needs of your site.</p>';
...
$accordion_block_content .= htmlentities('<button type="button" class="qapl-filter-button custom-class" data-button="quick-ajax-filter-button">QUICK_AJAX_LABEL</button>') . "\n";
