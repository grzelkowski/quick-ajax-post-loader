...
$accordion_block_content .= '<p>Create a file with any name, e.g., <code class="code-tag">loader-icon-custom-loader.php</code>, and place it in the directory <code class="code-tag">/wpg-quick-ajax-post-loader/templates/loader-icon/</code> in your theme or child theme. The plugin will automatically detect all files in this directory as available loading icons.</p>';
...
&lt;div class="quick-ajax-loader-custom"&gt;
    &lt;!-- Here, add your HTML code, GIF image, or CSS animation for the loading icon, e.g.: --&gt;
    &lt;img src="path/to/loader_image.gif" alt="Loading..." /&gt;
    &lt;!-- Or create a simple CSS animation --&gt;
...
<li><p>Test loading icons in different environments to ensure they are displayed correctly across all devices and in various browsers.</p></li>
<li><p>Use clean and efficient HTML/CSS code to ensure fast loading of icons.</p></li>
</ul>';
