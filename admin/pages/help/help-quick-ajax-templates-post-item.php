...
$accordion_block_content .= '<li><p>For the default post template: the file must be named <code class="code-tag">post-item.php</code> and placed in the directory <code class="code-tag">/qapl-quick-ajax-post-loader/templates/post-items/</code>. This file will automatically override the plugin\'s built-in default template.</p></li>';
...
$accordion_block_content .= '<p>You can also customize the message displayed when there are no posts to show by creating a <code class="code-tag">no-posts.php</code> file in the directory <code class="code-tag">/qapl-quick-ajax-post-loader/templates/</code>, to override the default message.</p>';
