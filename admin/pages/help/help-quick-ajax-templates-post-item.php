...
<li><p>For the default post template: the file must be named <code class="code-tag">post-item.php</code> and placed in the directory <code class="code-tag">/wpg-quick-ajax-post-loader/templates/post-items/</code>. This file will automatically override the plugin\'s built-in default template.</p></li>
<li><p>For custom templates: files must be named starting with <code class="code-tag">\'post-item\'</code>, e.g., <code class="code-tag">post-item-custom-name.php</code>. This naming format allows the plugin to identify the files as additional post templates.</p></li>
...
&lt;?php 
/* Post Item Name: My Custom Template Name */
?&gt;
&lt;div class="quick-ajax-post-item"&gt;
    &lt;a href="&lt;?php echo get_permalink() ?&gt;"&gt;
        &lt;!-- Here, add code to display the post, e.g., thumbnail, title --&gt;
    &lt;/a&gt;
&lt;/div&gt;
</code></pre>';
$accordion_block_content .= '<h4>"No Posts" Message</h4>';
$accordion_block_content .= '<p>You can also customize the message displayed when there are no posts to show by creating a <code class="code-tag">no-posts.php</code> file in the directory <code class="code-tag">/wpg-quick-ajax-post-loader/templates/</code>, to override the default message.</p>';
...
$accordion_block_content .= '<ul>
<li><p>By placing a template in the <strong>child theme</strong>, you ensure its persistence through theme updates.</p></li>
<li><p>By placing a template directly in the <strong>theme</strong>, you gain the ability for quick customization, but with the risk of losing changes during theme updates.</p></li>
<li><p>The plugin will automatically detect available templates in these locations and allow their selection in the shortcode configuration.</p></li>
</ul>';
$accordion_block_content .= '<h4>Best Practices</h4>';
$accordion_block_content .= '<ul>
<li><p>Name your template files clearly to easily identify them.</p></li>
<li><p>Test templates in different environments and configurations to ensure they look good on all devices and in various browsers.</p></li>
<li><p>Use appropriate CSS classes to ensure style consistency with the rest of your site.</p></li>
</ul>';
