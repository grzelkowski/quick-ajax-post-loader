<?php
$accordion_block_title = 'add_filter: How to Use `quick_ajax_modify_query`';
$accordion_block_content = '<p><strong>Description:</strong> The <code class="code-tag">quick_ajax_modify_query</code> filter allows for the customization of WP_Query arguments used in the <strong>Quick Ajax Post Loader</strong> plugin. This enables detailed control over AJAX query results, tailoring them to the unique needs of your site.</p>';
...
add_filter(\'quick_ajax_modify_query\', function($args, $quick_ajax_id) {
    // Using the AJAX identifier to modify query arguments
    if ($quick_ajax_id === \'some_specific_id\') {
        $args[\'posts_per_page\'] = 5; // Change the number of posts per page to 5
    }
    return $args;
}, 10, 2);
</code></pre>';
