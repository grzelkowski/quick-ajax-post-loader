...
class QAPL_Form_Field_Factory {
    ...
    public static function build_select_post_type_field(): QAPL_Form_Field_Interface {
        ...
        $builder->set_name(QAPL_Constants::QUERY_SETTING_SELECT_POST_TYPE);
        $builder->set_label(__('Select Post Type', 'quick-ajax-post-loader'));
        $builder->set_type('select');
        $builder->set_options($options);
        $builder->set_default(QAPL_Constants::QUERY_SETTING_SELECT_POST_TYPE_DEFAULT);
    ...
    public static function build_show_taxonomy_filter_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_SHOW_TAXONOMY_FILTER);
        $builder->set_label(__('Show Taxonomy Filter', 'quick-ajax-post-loader'));
        $builder->set_type('checkbox');
        $builder->set_default(QAPL_Constants::QUERY_SETTING_SHOW_TAXONOMY_FILTER_DEFAULT);
    ...
    public static function build_select_taxonomy_field(): QAPL_Form_Field_Interface {
        $options = [];
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_SELECT_TAXONOMY);
    ...
    public static function build_manual_term_selection_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_MANUAL_TERM_SELECTION);
        $builder->set_label(__('Select Specific Terms', 'quick-ajax-post-loader'));
        $builder->set_type('checkbox');
        $builder->set_default(QAPL_Constants::QUERY_SETTING_MANUAL_TERM_SELECTION_DEFAULT);
    ...
    public static function build_manual_selected_terms_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_SELECTED_TERMS);
    ...
    public static function build_posts_per_page_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_SELECT_POSTS_PER_PAGE);
        $builder->set_label(__('Posts Per Page', 'quick-ajax-post-loader'));
        $builder->set_type('number');
        $builder->set_default(QAPL_Constants::QUERY_SETTING_SELECT_POSTS_PER_PAGE_DEFAULT);
    ...
    public static function build_select_order_field(): QAPL_Form_Field_Interface {
        ...
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_SELECT_ORDER);
        $builder->set_label(__('Default Sort Order', 'quick-ajax-post-loader'));
        $builder->set_type('select');
        $builder->set_options($order_options);
        $builder->set_default(QAPL_Constants::QUERY_SETTING_SELECT_ORDER_DEFAULT);
    ...
    public static function build_select_orderby_field(): QAPL_Form_Field_Interface {
        ...
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_SELECT_ORDERBY);
        $builder->set_label(__('Default Sort By', 'quick-ajax-post-loader'));
        $builder->set_type('select');
        $builder->set_options($orderby_options);
        $builder->set_default(QAPL_Constants::QUERY_SETTING_SELECT_ORDERBY_DEFAULT);
    ...
    public static function build_show_sort_button_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_SHOW_SORT_BUTTON);
        $builder->set_label(__('Show Sorting Button', 'quick-ajax-post-loader'));
        $builder->set_type('checkbox');
        $builder->set_default(QAPL_Constants::QUERY_SETTING_SHOW_SORT_BUTTON_DEFAULT);
    ...
    public static function build_select_sort_button_options_field(): QAPL_Form_Field_Interface {
        ...
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_SELECT_SORT_BUTTON_OPTIONS);
    ...
    public static function build_show_inline_filter_sorting_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_SHOW_INLINE_FILTER_SORTING);
        $builder->set_label(__('Inline Filter & Sorting', 'quick-ajax-post-loader'));
        $builder->set_type('checkbox');
        $builder->set_default(QAPL_Constants::QUERY_SETTING_SHOW_INLINE_FILTER_SORTING_DEFAULT);
    ...
    /*
    public static function create_post_status_field(): QAPL_Form_Field_Interface {
        $post_status_options = [
            [
        ...
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_SELECT_POST_STATUS);
        $builder->set_label(__('Post Status', 'quick-ajax-post-loader'));
        $builder->set_type('select');
        $builder->set_options($post_status_options);
        $builder->set_default(QAPL_Constants::QUERY_SETTING_SELECT_POST_STATUS_DEFAULT);
    ...
    public static function build_excluded_post_ids_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_SET_POST_NOT_IN);
    ...
    public static function build_ignore_sticky_posts_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_IGNORE_STICKY_POSTS);
        $builder->set_label(__('Ignore Sticky Posts', 'quick-ajax-post-loader'));
        $builder->set_type('checkbox');
        $builder->set_default(QAPL_Constants::QUERY_SETTING_IGNORE_STICKY_POSTS_DEFAULT);
    ...
    public static function build_ajax_on_initial_load_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_AJAX_ON_INITIAL_LOAD);
        $builder->set_label(__('Load Initial Posts via AJAX', 'quick-ajax-post-loader'));
        $builder->set_type('checkbox');
        $builder->set_default(QAPL_Constants::QUERY_SETTING_AJAX_ON_INITIAL_LOAD_DEFAULT);
    ...
    public static function build_ajax_infinite_scroll_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_AJAX_INFINITE_SCROLL);
        $builder->set_label(__('Enable Infinite Scroll', 'quick-ajax-post-loader'));
        $builder->set_type('checkbox');
        $builder->set_default(QAPL_Constants::QUERY_SETTING_AJAX_INFINITE_SCROLL_DEFAULT);
    ...
    public static function build_show_end_message_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_SHOW_END_MESSAGE);
    ...
    public static function build_quick_ajax_css_style_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::LAYOUT_SETTING_QUICK_AJAX_CSS_STYLE);
        $builder->set_label(__('Apply Quick AJAX CSS Style', 'quick-ajax-post-loader'));
        $builder->set_type('checkbox');
        $builder->set_default(QAPL_Constants::LAYOUT_SETTING_QUICK_AJAX_CSS_STYLE_DEFAULT);
    ...
    public static function build_select_columns_qty_field(): QAPL_Form_Field_Interface {
        ...
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::LAYOUT_SETTING_SELECT_COLUMNS_QTY);
        $builder->set_label(__('Number of Columns', 'quick-ajax-post-loader'));
        $builder->set_type('select');
        $builder->set_options($columns_options);
        $builder->set_default(QAPL_Constants::LAYOUT_SETTING_SELECT_COLUMNS_QTY_DEFAULT);
    ...
    public static function build_post_item_template_field(): QAPL_Form_Field_Interface {
        ...
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::LAYOUT_SETTING_POST_ITEM_TEMPLATE);
    ...
    public static function build_taxonomy_filter_class_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::LAYOUT_SETTING_TAXONOMY_FILTER_CLASS);
        $builder->set_label(__('Add Class to Taxonomy Filter', 'quick-ajax-post-loader'));
        $builder->set_type('text');
        $builder->set_default(QAPL_Constants::LAYOUT_SETTING_TAXONOMY_FILTER_CLASS_DEFAULT);
    ...
    public static function build_container_class_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::LAYOUT_SETTING_CONTAINER_CLASS);
        $builder->set_label(__('Add Class to Post Container', 'quick-ajax-post-loader'));
        $builder->set_type('text');
        $builder->set_default(QAPL_Constants::LAYOUT_SETTING_CONTAINER_CLASS_DEFAULT);
        $builder->set_placeholder(__('class-name, another-class-name', 'quick-ajax-post-loader'));
    ...
    public static function build_show_custom_load_more_post_quantity_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_SHOW_CUSTOM_LOAD_MORE_POST_QUANTITY);
        $builder->set_label(__('Load More Post Quantity', 'quick-ajax-post-loader'));
        $builder->set_type('checkbox');
        $builder->set_default(QAPL_Constants::QUERY_SETTING_SHOW_CUSTOM_LOAD_MORE_POST_QUANTITY_DEFAULT);
    ...
    public static function build_select_custom_load_more_post_quantity_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::QUERY_SETTING_SELECT_CUSTOM_LOAD_MORE_POST_QUANTITY);
        $builder->set_label(__('Posts Per Load (After Initial)', 'quick-ajax-post-loader'));
        $builder->set_type('number');
        $builder->set_default(QAPL_Constants::QUERY_SETTING_SELECT_CUSTOM_LOAD_MORE_POST_QUANTITY_DEFAULT);
    ...
    public static function build_override_global_loader_icon_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::LAYOUT_SETTING_OVERRIDE_GLOBAL_LOADER_ICON);
        $builder->set_label(__('Override Global Loader Icon', 'quick-ajax-post-loader'));
        $builder->set_type('checkbox');
        $builder->set_default(QAPL_Constants::LAYOUT_SETTING_OVERRIDE_GLOBAL_LOADER_ICON_DEFAULT);
    ...
    public static function build_global_read_more_text_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::GLOBAL_READ_MORE_LABEL_FIELD);
    ...
    public static function build_global_show_all_label_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::GLOBAL_SHOW_ALL_LABEL_FIELD);
    ...
    public static function build_global_load_more_label_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::GLOBAL_LOAD_MORE_LABEL_FIELD);
    ...
    public static function build_global_no_post_message_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::GLOBAL_NO_POST_MESSAGE_FIELD);
    ...
    public static function build_global_end_post_message_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::GLOBAL_END_POST_MESSAGE_FIELD);
    ...
    public static function build_global_post_date_format_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::GLOBAL_POST_DATE_FORMAT_FIELD);
    ...
    */
    ...
    public static function build_global_sort_option_date_desc_label_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::GLOBAL_SORT_OPTION_DATE_DESC_LABEL_FIELD);
    ...
    public static function build_global_sort_option_date_asc_label_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::GLOBAL_SORT_OPTION_DATE_ASC_LABEL_FIELD);
    ...
    public static function build_global_sort_option_comment_count_desc_label_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::GLOBAL_SORT_OPTION_COMMENT_COUNT_DESC_LABEL_FIELD);
    ...
    public static function build_global_sort_option_title_asc_label_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::GLOBAL_SORT_OPTION_TITLE_ASC_LABEL_FIELD);
    ...
    public static function build_global_sort_option_title_desc_label_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::GLOBAL_SORT_OPTION_TITLE_DESC_LABEL_FIELD);
    ...
    public static function build_global_sort_option_rand_label_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::GLOBAL_SORT_OPTION_RAND_LABEL_FIELD);
    ...
    public static function build_global_remove_old_data_field(): QAPL_Form_Field_Interface {
        $builder = new QAPL_Form_Field_Builder();
        $builder->set_name(QAPL_Constants::REMOVE_OLD_DATA_FIELD);
        $builder->set_label(__('Confirm Purge of Old Data', 'quick-ajax-post-loader'));
        $builder->set_type('checkbox');
        $builder->set_default(QAPL_Constants::REMOVE_OLD_DATA_FIELD_DEFAULT);
