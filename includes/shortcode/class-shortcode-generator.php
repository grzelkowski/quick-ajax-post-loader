...
class QAPL_Quick_Ajax_Shortcode_Generator {
    ...
    public static function generate_shortcode(int $post_id): string {
        ...
        $serialized_data = get_post_meta($post_id, QAPL_Quick_Ajax_Constants::DB_POSTMETA_SHORTCODE_SETTINGS, true);
        ...
        if ($serialized_data) {
            ...
            if (is_array($form_data)) {
                $excluded_key = QAPL_Quick_Ajax_Constants::QUERY_SETTING_SET_POST_NOT_IN;
