...
class QAPL_Quick_Ajax_Enqueue_Handler implements QAPL_Quick_Ajax_Enqueue_Handler_Interface {
    ...
    public function enqueue_frontend_styles_and_scripts(): void {
        ...
        $style_url = $this->file_helper->get_plugin_css_directory() . 'style' . $style_suffix . '.css';
        $script_url = $this->file_helper->get_plugin_js_directory() . 'script' . $script_suffix . '.js';
    ...
    public function enqueue_admin_styles_and_scripts(): void {
        ...
        $style_url = $this->file_helper->get_plugin_css_directory() . 'admin-style' . $style_suffix . '.css';
        $script_url = $this->file_helper->get_plugin_js_directory() . 'admin-script' . $script_suffix . '.js';
