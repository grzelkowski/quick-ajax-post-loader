...
function qapl_initialize_plugin() {
    if (class_exists('QAPL_Quick_Ajax_Plugin_Starter')) {
        function qapl_quick_ajax_admin_notice() {
            echo '<div class="error"><p><strong>Quick Ajax Post Loader:</strong> A class named <strong>"QAPL_Quick_Ajax_Plugin_Starter"</strong> already exists, which may have been declared by another plugin.</p></div>';
        }
